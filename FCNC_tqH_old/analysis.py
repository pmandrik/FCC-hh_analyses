...
sample.mgp8_pp_tt_tcH_pt500 = get_my_component( "mgp8_pp_tt_tcH_pt500" )

selectedComponents_full = [
  # signal
  sample.mgp8_pp_tt_tuH,
  sample.mgp8_pp_tt_tuH_pt500,
  sample.mgp8_pp_tt_tcH_pt500,
...
if sample.mgp8_pp_tt_tcH_pt500 : sample.mgp8_pp_tt_tcH_pt500.splitFactor     =  50
...
sample.mgp8_pp_z0123j_4f_HT_0_150.splitFactor        =  10
sample.mgp8_pp_z0123j_4f_HT_150_300.splitFactor      =  10
sample.mgp8_pp_z0123j_4f_HT_300_500.splitFactor      =  10
sample.mgp8_pp_z0123j_4f_HT_500_1000.splitFactor     =  10
sample.mgp8_pp_z0123j_4f_HT_1000_2000.splitFactor    =  10
sample.mgp8_pp_z0123j_4f_HT_2000_5000.splitFactor    =  10
sample.mgp8_pp_z0123j_4f_HT_5000_100000.splitFactor  =  10
...
testComponents = [ 
  cfg.Component( 'example_signal_tuH', files = [ path + "mgp8_pp_tt_tuH_pt500/events_177969217.root" ] ),
  cfg.Component( 'example_signal_', files = [ path + "mgp8_pp_tt_tcH_pt500/events_092684759.root" ] ),
...
from heppy.FCChhAnalyses.FCChh.FCNC_tqH_old.selection import Selection
