...
void tmva_analyse_file(TFile * file, string out_name, double xfactor){
  ...
  Double_t * gen_t_pt = event.GetVar("gen_t_pt");
  Double_t * dR_gen_u_gen_photon = event.GetVar("dR_gen_u_gen_photon");
  Double_t * gen_t_m = event.GetVar("gen_t_m");
  Double_t * M_gen_u_gen_photon = event.GetVar("M_gen_u_gen_photon");
  Double_t * gen_u_eta = event.GetVar("gen_u_eta");
  Double_t * gen_photon_eta = event.GetVar("gen_photon_eta");
  Double_t * gen_u_pt = event.GetVar("gen_u_pt");
  Double_t * gen_photon_pt = event.GetVar("gen_photon_pt");
  //[[[end]]]
